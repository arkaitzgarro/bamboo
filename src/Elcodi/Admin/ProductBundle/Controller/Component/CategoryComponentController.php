...
class CategoryComponentController extends AbstractAdminController
{
    ...
    {
        $category_manager = $this->get('elcodi.core.product.service.category_list');
        $category_list    = $category_manager->buildCategoryList();

        return ['categories_list' => $category_list];
    }
